...
imgs[0]= loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1687153640/LongSleeveShirt_Trial1_u2hlx2.png')
 ...
 imgs[3] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1687198676/LongSleeveShirt_Trial4_pyplwa.png') 
  ...
  imgs[20] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1687233033/LongSleeveShirt_Trial20_focrhc.png')   
    ...
    imgs[153] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688788142/LongSleeveShirt_Trial153_dockbq.png')
    
    imgs[154] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688788267/LongSleeveShirt_Trial154_bycdz6.png')
    
    imgs[155] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688789165/LongSleeveShirt_Trial155_kzlnpf.png')
    
    imgs[156] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688858204/LongSleeveShirt_Trial157_xeajjm.png')
    
    imgs[157] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688858204/LongSleeveShirt_Trial158_fnveim.png')
    
    imgs[158] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688858204/LongSleeveShirt_Trial156_opr0gm.png')
    
    imgs[159] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688859550/LongSleeveShirt_Trial159_u7l81y.png')
 
    imgs[160] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688859550/LongSleeveShirt_Trial160_pp3hvy.png')
    
    imgs[161] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688861952/LongSleeveShirt_Trial161_u1ujyh.png')
    
    imgs[162] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688862626/LongSleeveShirt_Trial162_q9zx7s.png')
    
    imgs[163] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1689381734/LongSleeveShirt_Trial164_xystes.png')
    
    imgs[164] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1689381734/LongSleeveShirt_Trial163_wcichd.png')
    
    imgs[165] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1690081541/LongSleeveShirt_Trial166_gnazix.png')
    
    imgs[166] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1690081541/LongSleeveShirt_Trial165_dkxedl.png')
    
    // imgs[167] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688078160/LongSleeveShirt_Trial105_dkdggl.png')
    // imgs[168] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688078160/LongSleeveShirt_Trial105_dkdggl.png')
    // imgs[169] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688078160/LongSleeveShirt_Trial105_dkdggl.png')
    // imgs[170] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688078160/LongSleeveShirt_Trial105_dkdggl.png')
    // imgs[171] = loadImage('https://res.cloudinary.com/painkillerkid/image/upload/v1688078160/LongSleeveShirt_Trial105_dkdggl.png')
